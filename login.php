<html>
    ...
    <body>
        ...
        <form method="POST" action="login_submit.php">
                <div class="form-group">Student Id : <input class="form-control"  type="text" placeholder="reg" name="reg" pattern="^[0-9]+l31a+[0-9]{4}$" required></div> 
	        ...
	        <?php
                ...
                <div class="form-group"><a class="btn btn-primary form-control" href="fac.php">Faculty Login</a></div>
                <div class="form-group">Dont have account? <a href="login.php?acc=new">Signup</a></div>
        </form>

            <?php
            }elseif(isset($_GET['acc'])) { ?>
            <form action="signup_submit.php" method="POST" >
                <div class="form-group">Student Id : <input class="form-control"  type="text" placeholder="reg" name="reg"  required></div> 
                <div class="form-group">Password : <input class="form-control"  type="password" placeholder="Password" name="password" pattern=".{6,}" required></div>
